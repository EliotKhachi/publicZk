...
1. Ensure that the transmitter and the receiver agree on what serial communication protocol is being used, for example [I2C Communication](../202111020424).  
2. The 1s and 0s (bits) on the data bus occur in parallel with a [Clock Bus](../202305300022).  
