...
A *target* is written in the beginning of a *rule*. A conventional target is the name of the file that is generated by a program. It is immediately followed by a `:` and *prerequisites* [\[A Prerequisite in a Makefile\]](../202110182309), and of course a new line, tab and the *recipe*. Examples of targets are executable `.bin` or object `.o` files.
